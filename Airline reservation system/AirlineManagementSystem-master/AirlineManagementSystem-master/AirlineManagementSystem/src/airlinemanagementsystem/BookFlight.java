        ...
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No user found with the provided Aadhar number.");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No Flights Found for the selected route.");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            if (aadhar.isEmpty() || name.isEmpty() || nationality.isEmpty() || flightname.isEmpty() || ddate.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please fill in all details, including selecting a date.");
                return;
            }
            ...
            try {
                ...
                if (selectedDate.before(currentDate)) {
                    JOptionPane.showMessageDialog(null, "Flight cannot be booked for past dates. Please select a future date.");
                    return;
                }
